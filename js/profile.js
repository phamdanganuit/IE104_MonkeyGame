document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('profile-email').querySelector('span').textContent = currentUser.email || '';
...
document.addEventListener('DOMContentLoaded', function() {
    const logoutLinks = document.querySelectorAll('.logout-btn, [onclick="handleLogout(event)"]');
